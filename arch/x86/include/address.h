...
#define PHY_HS_CACHE_BASE_ADDR       0x600000
...
#define PAGE_MM_LIST_SIZE         (PHY_HS_CACHE_BASE_ADDR - PHY_PAGE_MM_LIST_BASE_ADDR)
#define SYS_HS_CACHE_SIZE        (PHY_IDLE_MEM_BASE_ADDR - PHY_HS_CACHE_BASE_ADDR)
...
#define HS_CACHE_BASE_ADDR             (SYS_BASE_LINEAR_ADDR + PHY_HS_CACHE_BASE_ADDR)
